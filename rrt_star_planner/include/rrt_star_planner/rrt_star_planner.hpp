#ifndef RRT_STAR_PLANNER__RRT_STAR_PLANNER_HPP_
#define RRT_STAR_PLANNER__RRT_STAR_PLANNER_HPP_
...
public:
  ...
  // Jazzy API: Costmap2DROS (was CostmapROS in Humble)
  void configure(
  ...
  // Jazzy API: createPlan has a cancel_checker argument
...
private:
  ...
  std::vector<int> nearNodes(const std::vector<Node> & tree, const Node & q, double r);
  void rewire(std::vector<Node> & tree, int new_idx, const std::vector<int> & near);
...
#endif  // RRT_STAR_PLANNER__RRT_STAR_PLANNER_HPP_
